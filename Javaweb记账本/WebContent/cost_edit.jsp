...
<body>
	<div id="header">
		<span class="wel_word">编辑消费记录${sessionScope.username}</span>
		<div>
	...
	<div id="main">
		<form id="form1" action="${pageContext.request.contextPath }/manager/homeCostServlet" method="get" onsubmit="return check()">
			...
			<table>
				...
				<tr>
					...
					<td rowspan="2"><input id="tablesubmit"type="submit" value="提交"/></td>
				</tr>
				<tr><td colspan="3"><textarea id="note" name="note" rows="5" cols="75" placeholder="账单详情描述"></textarea> </td></tr>	
			</table>
		</form>
	</div>
</body>
